...
class GetServicePointDetailResponse extends AbstractStructBase
{
     ...
     * @param \StructType\ServicePoint $servicePointDetail
     */
    public function __construct(\StructType\ServicePoint $servicePointDetail = null)
    {
        $this
     ...
     * @return \StructType\ServicePoint|null
     */
     ...
     * @param \StructType\ServicePoint $servicePointDetail
     * @return \StructType\GetServicePointDetailResponse
     */
    public function setServicePointDetail(\StructType\ServicePoint $servicePointDetail = null)
    {
