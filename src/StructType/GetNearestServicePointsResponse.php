...
class GetNearestServicePointsResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \ArrayType\ArrayOfNearbyServicePoint
     */
     ...
     * @param \ArrayType\ArrayOfNearbyServicePoint $servicePoints
     */
    public function __construct(\ArrayType\ArrayOfNearbyServicePoint $servicePoints = null)
    {
        $this
     ...
     * @return \ArrayType\ArrayOfNearbyServicePoint|null
     */
     ...
     * @param \ArrayType\ArrayOfNearbyServicePoint $servicePoints
     * @return \StructType\GetNearestServicePointsResponse
     */
    public function setServicePoints(\ArrayType\ArrayOfNearbyServicePoint $servicePoints = null)
    {
